...
BUILTIN_PLUGINS: tuple[PluginManifest, ...] = (
    ...
    PluginManifest(
        "themes",
        "plugins.placeholder.theme",
        "plugins.description.theme",
        "🎨",
        entrypoint="writeonside_app.builtin_plugins.theme_editor:run",
    ),
    PluginManifest(
        "color_picker",
        "plugins.color_picker.name",
        "plugins.color_picker.description",
        "💧",
        entrypoint="writeonside_app.builtin_plugins.color_picker:run",
    ),
