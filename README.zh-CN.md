<p align="center">
  <img src="assets/writeonside_logo_light.svg" alt="WriteOnSide 标志" width="96" />
</p>

<h1 align="center">WriteOnSide</h1>

<p align="center">
  <strong>轻量级 Windows 侧边栏 Markdown 笔记应用。</strong><br />
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.0.48-2ea44f" alt="版本 0.0.48" />
</p>
...
WriteOnSide 将 Markdown 笔记保存在你指定的文件夹中。没有私有数据库，也不强制使用云服务，因此同一 Vault 可在 WriteOnSide、Obsidian、VS Code 或其他编辑器中打开。

> [!NOTE]
> WriteOnSide `0.0.48` 为开发中的预发布版本。升级前请备份重要笔记并查看发行说明。
...
WriteOnSide 目前以便携式单文件 Windows 应用分发：
...
WriteOnSide 不需要账号或内置云服务。笔记仅在你自行配置的同步服务中离开本机。
...
LICENSE                 WriteOnSide 源码 MIT 许可证
```

## 许可证

WriteOnSide 原创源码采用 [MIT 许可证](LICENSE)。

第三方组件仍受其各自许可证约束，见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。

<p align="center">
  <sub>Python | Tkinter | Markdown | 兼容 Obsidian 的纯文本笔记</sub>
</p>
