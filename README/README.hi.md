...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.0.50-2ea44f" alt="संस्करण 0.0.50" />
</p>
...
> [!NOTE]
> WriteOnSide `0.0.50` सक्रिय विकास में एक प्री-रिलीज़ परियोजना है। अपग्रेड से पहले महत्वपूर्ण नोट का बैकअप लें और रिलीज़ नोट पढ़ें।
