...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.0.50-2ea44f" alt="버전 0.0.50" />
</p>
...
> [!NOTE]
> WriteOnSide `0.0.50`은 활발히 개발 중인 사전 출시 프로젝트입니다. 업그레이드 전에 중요한 노트를 백업하고 릴리스 노트를 확인하세요.
