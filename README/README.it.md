...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.2-2ea44f" alt="Versione 0.1.2" />
</p>
...
> [!NOTE]
> WriteOnSide `0.1.2` è un progetto pre-release in sviluppo attivo. Esegui il backup delle note importanti e consulta le note di rilascio prima di aggiornare.
